...
export const STRINGS = {
  tr: {
    ...
    mdTip: "Ders planını bir metin dosyası (.md) olarak indirir. Bilgisayarınıza kaydedip Word, Google Docs veya Not Defteri ile açabilirsiniz.",
  ...
  en: {
    ...
    mdTip: "Downloads the lesson plan as a text file (.md). Save it to your computer and open it in Word, Google Docs, or any text editor.",
